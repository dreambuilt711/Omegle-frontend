    ...
    return (
        <ModalBackground>
            <Modal className='termsBox'>
                <ModalCloseWrapper>
                    <ModalClose onClick={() => setIsTermsModalVideo(false)}><IoClose /></ModalClose>
                </ModalCloseWrapper>
                <InputWrapper>
                    <span>
                ...
                {/* <Button className='allowVideo' onClick={allowMediaDevice} style={{ marginTop: "15px"}}>Allow Video & Audio</Button> */}
                <InputWrapper style={{ marginTop: "15px" }}>
                    <span>
                        <input className='modalInput' type="checkbox" checked={check3} onChange={allowMediaDevice} />
                    </span>
                    <CheckBoxLabel className='modalText'>Allow Video & Audio</CheckBoxLabel>
                </InputWrapper>
                <SubmitButtonWrapper>
                    <Button className='confirmBtn' onClick={navigateToChat} disabled={!check1 || !check2 || !check3}>Confirm & continue</Button>
                </SubmitButtonWrapper>
            </Modal>
        </ModalBackground>
    )
...
export default TermsModalVideo
