    ...
    return (
        <>
            ...
            <Wrapper className="videoWrapper">
                <VideoWrapper className="v-videoWrapper">
                    {
                        callAccepted
                        ? (<Camera ref={userVideo} autoPlay playsInline></Camera>)
                        :(<LoadingCamera>
                            <div className="grid h-full w-full min-h-36 place-items-center overflow-x-scroll rounded-lg p-6 lg:overflow-visible">
